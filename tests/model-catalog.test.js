...
const expectedModels = [
    ...
    { label: 'GLM-4.7 400B-A32B MoE (~800GB total, ~64GB active)', value: '32', memory: '800', activeMemory: '64', quant: '0.5' },
    { label: 'GLM-5 744B-A40B MoE (~1488GB total, ~80GB active)', value: '40', memory: '1488', activeMemory: '80', quant: '0.5' },
    { label: 'GLM-5.1 744B-A40B MoE (~1488GB total, ~80GB active)', value: '40', memory: '1488', activeMemory: '80', quant: '0.5' },
    { label: 'Gemma 4 E2B (~5GB)', value: '2.3', memory: '5', quant: '1.0' },
    { label: 'Gemma 4 E4B (~9GB)', value: '4.5', memory: '9', quant: '1.0' },
    { label: 'Gemma 4 12B Unified (~24GB)', value: '12', memory: '24', quant: '1.0' },
    { label: 'Gemma 4 26B-A4B MoE (~52GB total, ~8GB active)', value: '4', memory: '52', activeMemory: '8', quant: '0.5' },
    { label: 'Gemma 4 31B (~62GB)', value: '31', memory: '62', quant: '0.5' },
    { label: 'Qwen3.6 27B (~54GB)', value: '27', memory: '54', quant: '1.0' },
    { label: 'Qwen3.6 35B-A3B MoE (~70GB total, ~6GB active)', value: '3', memory: '70', activeMemory: '6', quant: '1.0' },
    { label: 'Step3 321B-A38B VLM (~642GB total, ~76GB active)', value: '38', memory: '642', activeMemory: '76', quant: '0.5' },
    { label: 'Step 3.5 Flash 196B-A11B (~392GB total, ~22GB active)', value: '11', memory: '392', activeMemory: '22', quant: '0.5' },
    { label: 'Step 3.7 Flash 198B-A11B VLM (~396GB total, ~22GB active)', value: '11', memory: '396', activeMemory: '22', quant: '0.5' },
